...
// These are the @google/gemini-cli application's own OAuth credentials.
// It is safe to commit these because this is an "installed application" flow:
// https://developers.google.com/identity/protocols/oauth2#installed
// "The process results in a client ID and, in some cases, a client secret,
// which you embed in the source code of your application. (In this context,
// the client secret is obviously not treated as a secret.)"
// The Gemini CLI open-source repo commits the same values in its own oauth2.js.
